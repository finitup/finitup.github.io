function StrategyCard({ 
  ...
  // Helper function to get an icon based on type
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="text-center">
            ...
            <div className="font-medium">{returnRange}</div>
          </div>
          <div className="text-center">
            <div className="text-sm text-gray-500 mb-1">Horizon</div>
            <div className="font-medium">{timeHorizon}</div>
          </div>
        </div>
